...
using Awine.Teach.TeachingAffairService.Configurations;
using Awine.Teach.TeachingAffairService.Application.Extensions;
...
{
    /// <summary>
    /// TeachingAffair Service Startup
    /// </summary>
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTeachingAffairServiceMySQLProvider(options =>
            {
            ...
            services.AddTeachingAffairServiceApplication();
