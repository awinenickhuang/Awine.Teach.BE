...
namespace Awine.Teach.FoundationService.Domain.Interface
{
    ...
    public interface IUsersRepository
    {
        ...
        /// <returns></returns>
        Task<IPagedList<Users>> GetPageList(int pageIndex = 1, int pageSize = 15, string userName = "", string phoneNumber = "", string tenantId = "", string departmentId = "", string roleId = "");
