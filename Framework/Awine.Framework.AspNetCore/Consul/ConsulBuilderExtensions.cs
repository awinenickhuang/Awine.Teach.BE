...
namespace Awine.Framework.AspNetCore.Consul
{
    public static class ConsulBuilderExtensions
    {
        ...
        {
            var applicationLifetime = app.ApplicationServices.GetRequiredService<IHostApplicationLifetime>() ?? throw new ArgumentException("Missing Dependency", nameof(IHostApplicationLifetime));
            ...
            foreach (var address in addresses)
            {
                ...
                logger.LogInformation($"Registering additional health check:checking uri:{healthCheck}");
        ...
        public static RegistryInformation AddTenant(this IApplicationBuilder app, string serviceName, string version, Uri uri, Uri healthCheckUri = null, IEnumerable<string> tags = null)
        {
            ...
            var registryInformation = serviceRegistry.RegisterServiceAsync(serviceName, version, uri, healthCheckUri, tags).Result;
        ...
        /// </summary>
        /// <param name="app"></param>
        /// <param name="registryInformation"></param>
