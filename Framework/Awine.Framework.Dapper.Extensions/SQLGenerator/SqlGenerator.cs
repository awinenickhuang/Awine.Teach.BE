...
using Awine.Framework.Dapper.Extensions.Attributes.LogicalDelete;
...
namespace Awine.Framework.Dapper.Extensions.SQLGenerator
{
        ...
        where TEntity : class
    {
        ...
        public SQLGenerator()
        {
            Provider = AwineDapperConfig.SqlProvider;
            
            if (UseQuotationMarks == null)
                UseQuotationMarks = Provider != SqlProvider.SQLite && AwineDapperConfig.UseQuotationMarks;
